    ...
    render() { 
        return ( 
            <div className="question">
                ...
                <input onClick={() => {this.props.onRadio(0)}} checked={this.props.questions[this.props.currentSection][this.props.currentQuestionId].optionChosen[0]} type="radio" id="A" name="option"></input>
